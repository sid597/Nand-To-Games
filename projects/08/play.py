...
#     return d
#
# print extract_functions(['function Sys.init 0', 'push constant 6', 'push constant 8', 'call Class1.set 2', 'pop temp 0', 'push constant 23', 'push constant 15', 'call Class2.set 2', 'pop temp 0', 'call Class1.get 0', 'call Class2.get 0', 'label WHILE', 'goto WHILE'])
# #
# #
# #
...
#
#
# def call_function_command( command):
#     function_name, no_of_arguments = command.split()[1:]
#     print function_name,no_of_arguments
#     with open("./call.vm", 'r') as call_commands_file:
#         call_command_list = call_commands_file.read().splitlines()
#     call_commands_file.close()
#     call_list = []
#     for command in call_command_list:
#         if '%s' in command:
...
# pprint (call_function_command("call Class1.set 2"))
# import os
# dir_name = "FibonacciElement"
# dire = os.getcwd() + "/" + dir_name +"/"+ dir_name
# print dire
# for dirpath, dirnames, files in os.walk(dire):
#     print files
